...
class BasicPlugin(Plugin):
    ...
    def on_auditme(self, event):
        ...
        channel = event.guild.create_channel(
            "audit-log-test", "text", reason="TEST CREATE"
        )
    ...
    def send_welcome_dm(self, event):
        ...
        event.member.user.open_dm().send_message(
            "Hi there! Welcome to our friendly community."
        )
