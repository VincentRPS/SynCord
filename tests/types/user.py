...
def test_user_avatar_url():
    ...
    assert (
        avatar_url
        == "https://cdn.discordapp.com/avatars/12345/1234567890abcdefghijkl.png?size=1024"
    )
...
def test_user_animated_avatar_url():
    ...
    assert (
        u.avatar_url
        == "https://cdn.discordapp.com/avatars/12345/a_1234567890abcdefghijkl.gif?size=1024"
    )
    avatar_url = u.get_avatar_url(animated_format="webp")
    assert (
        avatar_url
        == "https://cdn.discordapp.com/avatars/12345/a_1234567890abcdefghijkl.webp?size=1024"
    )
